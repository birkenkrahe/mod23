...
- Exercise 2 batch: remember to submit a *published* notebook (Thu)
- Review: test 3 (results aren't great - why?)
- Review: 1st sprint review (proposal) - what're you proud of?
...
- Next: incremental modeling (bikeshare system part III)
