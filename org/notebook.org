...
- Building a population model - part II (model and simulate)

- Sample solutions bonus challenges (video?)
  
* 10.1 Tue-Oct-24 - Iterating population models

- Iterating the population model (Downey, ch. 6)
...
Limits to growth - improving the population model (Downey, ch. 7)
